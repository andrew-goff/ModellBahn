 ...
 */
public interface INamedItemPersister<E extends INamedItem> extends IPersister<E> {
    
    /**
     * Adds the entity checking the primary name; fails if the entity all ready exists.
     *
    ...
    /**
     * Finds the entity by primary name.
     *
     * @param id the id
     * @param eager TODO
     * @return the entity
    ...
    /**
     * Finds the entity by business name.
     *
     * @param name the name to scan for only fields annotated with @BusinessKey are considered
     * @param eager TODO
     * @return the entity
     * @throws Exception if there more than one match or there is a DB error
     */
    ...
    E update(String name, E entity) throws Exception;

    /**
     * Deletes the specified entity by primary name.
     *
    ...
    /**
     * Deletes the specified entity by business name.
     *
