 ...
 */
public abstract class AbstractItemService<I extends IItem> extends AbstractService {
  ...
  protected URI serviceURI;
    ...
    private Response update(Long id, I entity) {
      return update(new Finder() { public Long getId() { return id;} }, entity);
    }
    ...
    private Response update(Finder finder, I entity) {
      try {
        logPut(finder.getId() + ": " + entity);

        I result = getPersister().update(finder.getId(), entity);
  ...
  protected Link getPageLink(UriInfo info, Integer pageNumber, Integer pageSize, String rel) {
     ...
     */
    protected IPersister<I> getPersister() {
        return persister;
    }
  ...
  protected String getEntityClassName() {
     ...
     */
    private Map<String, Selector> getSelectors() {
        return selectors;
    }
     ...
     */
    protected I create() throws Exception {
  ...
  private void setServiceURI(URI serviceURI) {
